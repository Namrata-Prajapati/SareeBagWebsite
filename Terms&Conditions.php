...
<?php
    ...
    ?>
      <!-- <hr style="color: blueviolet; "> -->
        <center>
            <h6 style="font-size: x-large; font-weight: bolder;">Terms and Conditions of Use</h6>
              
                <h4 style="font-size: x-large; font-weight: normal;">
                    Thank you for visiting Traditional Fashions, 
                    the website and online saree shopping destination of FTD Pvt. LTd, 
                    the owner of the platform and being referred to here as ‘we’ or ‘us’. 
                    This section will help you understand the terms and conditions of using this website, 
                    its services and the larger scope of it including delivery, 
                    creative content and so on. 
                    Each aspect of it will be henceforth called the ‘Service’ collectively. 
                    It is implied that you agreed and are bound by the Agreement, 
                    upon using the Services of Traditional Fashions, 
                    irrespective of your registration status with us.
                </h4>
        </center>
        <!--Footer-->
